...
const Contract = (props) => {
    ...
    if(props.order.maker==='megalit'){
        maker = 'Общество с ограниченной отвественностью "Мегалит Гран",' +
    ...
    return (
        <div>
            <div className={c.wrapper}>
                <p className={c.title}>ДОГОВОР № {props.order.number}/{(props.order.termin.date_start).slice(8,10)} от {props.order.termin.date_start}</p>
                ...
                <ol>
                    ...
                    <li>СТОИМОСТЬ РАБОТ И ПОРЯДОК РАСЧЕТОВ <ol>
                        ...
                        являющейся неотъемлемой его частью, и составляет <span className={c.ramka}><b>{(props.calculator.totalBLR).toFixed(2)}</b></span>  бел.руб.</li>
                        <li>Работа оплачивается Заказчиком в беларуских рублях в следующем порядке: <ol>
                            <li>путем внесения аванса в размере: <span className={c.ramka}><b>{(props.calculator.avanceBLR).toFixed(2)}</b></span> бел.руб.</li>
                    ...
                    <li>ОСОБЫЕ УСЛОВИЯ <ol>
                        ...
                        (ограды)  - гарантия не распространяется, на монтажные работы и работы по благоустройству - согласно спецификации.</li>
